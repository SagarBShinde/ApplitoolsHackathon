...
import sbs.ufg.hackathon.modern.v1.tests.components.FilterButtons;
import sbs.ufg.hackathon.modern.v1.tests.components.MainNavBar;
import sbs.ufg.hackathon.modern.v1.tests.components.ProductInGrid;
import sbs.ufg.hackathon.modern.v1.tests.components.ProductSection;
import sbs.ufg.hackathon.modern.v1.tests.productFilter.BrandsFilter;
import sbs.ufg.hackathon.modern.v1.tests.productFilter.ColorFilter;
import sbs.ufg.hackathon.modern.v1.tests.productFilter.PriceFilter;
import sbs.ufg.hackathon.modern.v1.tests.productFilter.TypeFilter;
