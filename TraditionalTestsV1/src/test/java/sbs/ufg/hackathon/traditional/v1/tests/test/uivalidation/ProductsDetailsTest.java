...
public class ProductsDetailsTest extends AppliToolsBaseTest {
	...
	// This test is not writting anything into report hence total number of records in report will differ by 7.
	@Test(description = "Validate Product Details" , priority = 0)
	public void selectProductFromFilterResults() throws FrameworkException {
			
	sbs.ufg.hackathon.traditional.v1.tests.pages.HomePage homePage = new HomePage(this.getDriver());
