...
public class FilterTest extends AppliToolsBaseTest {
	...
	public void validateOffRibbon() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate Off Ribbon first product",homePage.product.getLocator("offRibbon"),this.testTarget );
	...
	public void validateProductImage() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate product image",homePage.product.getLocator("productImage"),this.testTarget );
	...
	public void validateCountDown() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate count down",homePage.product.getLocator("countDown"),this.testTarget );
	...
	public void validateProductName() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate product name",homePage.product.getLocator("productName"),this.testTarget );
	...
	public void validateOriginalPrice() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate original price",homePage.product.getLocator("originalPrice"),this.testTarget );
	...
	public void validateSalePrice() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate sale price",homePage.product.getLocator("salePrice"),this.testTarget );
	...
	public void validateAddToCartInProduct() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate cart icon",homePage.product.getLocator("addToCart"),this.testTarget );
	...
	public void validateWishListInProduct() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate wish list icon",homePage.product.getLocator("wishList"),this.testTarget );
	...
	public void validateAddToCompareInProduct() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 2, Test Name: Validate Add to compare icon",homePage.product.getLocator("addToCompare"),this.testTarget );
