...
public class CrossDeviceElementTest_2 extends AppliToolsBaseTest {
	

	 public CrossDeviceElementTest_2(TestTarget target) {
		    this.testTarget = target;
		 }
		    
	public CrossDeviceElementTest_2() {
	}
	...
	public void validateProductId() throws FrameworkException {
		...
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Product Id",productDetailPage.productInfo.getLocator("productId"),this.testTarget );
