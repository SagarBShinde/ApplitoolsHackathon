...
@Test
@TestTargetList({"Tablet_all", "Laptop_all", "Mobile_chrome"})
public class CrossDeviceElementTest extends AppliToolsBaseTest {

	 public CrossDeviceElementTest(TestTarget target) {
		    this.testTarget = target;
		 }
		    
	public CrossDeviceElementTest() {
	}
	...
	public void validateHomeMenu() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Home Menu",homePage.appHeader.getLocator("homeMenu"),this.testTarget );
	...
	public void validateMenMenu() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Men Menu",homePage.appHeader.getLocator("menMenu"),this.testTarget );
	...
	public void validateWomenMenu() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Women Menu",homePage.appHeader.getLocator("womenMenu"),this.testTarget );
	...
	public void validateRunningMenu() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Running Menu",homePage.appHeader.getLocator("runningMenu"),this.testTarget );
	...
	public void validateTrainingMenu() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Training Menu",homePage.appHeader.getLocator("trainingMenu"),this.testTarget );
	...
	public void validateBlackFilterSection() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Black Filter Section",homePage.colorFilter.getLocator("blackFilterSection"),this.testTarget );
	...
	public void validateSearchInput() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Search Input",homePage.mainNavBar.getLocator("searchInput"),this.testTarget );
	...
	public void validatesearchBtnWeb() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate search button for Laptop and Tablet",homePage.mainNavBar.getLocator("searchBtnWeb"),this.testTarget );
	...
	public void validatesearchBtnMob() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate search button for Mobile",homePage.mainNavBar.getLocator("searchBtnMob"),this.testTarget );
	...
	@Test(description = "Validate Cart Button on the home page")
	public void validateCartBtn() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Cart Button",homePage.mainNavBar.getLocator("cart"),this.testTarget );
	...
	public void validateOpenFilterBtn() throws FrameworkException {
		HomePage homePage = new HomePage(this.getDriver());
		StringBuilder reportRec = this.getReportLine("Task: 1, Test Name: Validate Open Filter Button:",homePage.productSection.getLocator("openFilterBtn"),this.testTarget );
